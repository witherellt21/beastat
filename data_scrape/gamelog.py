...
class GamelogScraper(AbstractBaseScraper):
    ...
    COLUMN_TYPES: dict[str: str] = {
        "Tm": "str", "Opp": "str", "PTS": "float", "GmSc": "float",
        "G": "float", "GS": "float", "MP": "float",  "AST": "float", 
        "TRB": "float", "FT": "float", "THPA": "float", "THP": "float", 
        "FGA": "float", "FG": "float", "STL": "float", "FG_perc": "float", 
        "THP_perc": "float", "plus_minus": "float", "FTA": "float",
        "FT_perc": "float", "ORB": "float", "DRB": "float", "BLK": "float", 
        "TOV": "float", "PF": "float", "GmSc": "float", "plus_minus": "float",
    }
